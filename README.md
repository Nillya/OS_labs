...
📦 **OS_labs**  
 ...
 ┃ ┣ 📂 [СРС_WORK-CASE №4](https://github.com/Nillya/OS_labs/tree/main/work-cases/%D0%A1%D0%A0%D0%A1_WORK-CASE%20%E2%84%964) # Віртуалізація та мережева взаємодія в Linux: клонування, підключення, управління пакетами   
 ...
 ┃ ┣ 📂 [LAB №6](https://github.com/Nillya/OS_labs/tree/main/labs/) # Команди Linux для архівування та стиснення даних. Робота з текстом  
